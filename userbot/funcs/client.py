...
class luciferXClient(TelegramClient):
    def lucifer_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    luciferub.add_event_handler(func, events.MessageEdited(**kwargs))
                luciferub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                luciferub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                luciferub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
luciferXClient.fast_download_file = download_file
luciferXClient.fast_upload_file = upload_file
luciferXClient.reload = restart_script
luciferXClient.get_msg_link = get_message_link
luciferXClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    luciferXClient.send_message = send_message
    luciferXClient.send_file = send_file
    luciferXClient.edit_message = edit_message
