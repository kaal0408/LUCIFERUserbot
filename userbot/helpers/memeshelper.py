...
PROGQUOTES = [
    ...
    "Most software today is very much like an Egyptian pyramid with millucifers of bricks piled on top of each other, with no structural integrity, but just done by brute force and thousands of slaves.",
