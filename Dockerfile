...
#Import Gudz
RUN wget https://raw.githubusercontent.com/kaal0408/LuciferUserbot/master/manjeet.py
RUN wget https://raw.githubusercontent.com/kaal0408/LuciferUserbot/master/requirements.txt
#Start Fumkin
